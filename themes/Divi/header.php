...
?>
    ...
    <?php echo $et_top_info_defined ? '' : 'style="display: none;"'; ?> >
        ...
        span
    id = "et-info-phone" >
        <?php echo et_core_esc_previously( et_sanitize_html_input_text( strval( $et_phone_number ) ) ); ?> < /span>
    <?php endif; ?>
    ...
    <?php if ( $et_slide_header || is_customize_preview() ) : ?>
        ...
        span
    class =
        "mobile_menu_bar et_pb_header_toggle et_toggle_<?php echo esc_attr( et_get_option( 'header_style', 'left' ) ); ?>_menu" >
        <
        /span>
    <?php endif; ?>
